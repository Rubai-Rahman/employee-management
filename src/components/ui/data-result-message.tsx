 ...
 * @returns {JSX.Element} A JSX.Element that renders a div containing the optionally rendered icon
...
const DataResultMessage = ({
  ...
  return (
    <div className="flex size-full flex-col items-center justify-center gap-3 p-3 text-secondary-foreground">
      {renderedElement}
...
export const NotFoundMessage = ({
  ...
  >
    <Button variant="outline-colored" asChild>
